...
colors = ['block','blue','yellow','green']
...
"""data = { 'names':['peter mugabo','uwera jane','james'],
'age':[20,15,30],
'gender':['male','female','male']
}
gash=pd.DataFrame(data)

gash['marks']=[60,20,50]
print(gash)
print("\n average")
gash.to_csv(data.csv)

"""

fi=open("C:\Users\user\Desktop\gash/gg.py","r")
print(fi.read())